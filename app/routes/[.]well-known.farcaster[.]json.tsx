...
export const loader = async () => {
  const manifest = {
    ...
    miniapp: {
      version: '1',
      name: 'Dopamint from api',
      homeUrl: 'https://test-remix-2.vercel.app/',
      imageUrl: 'https://test-remix-2.vercel.app/32ratio.png',
      buttonTitle: '🚀 Launch',
      iconUrl: 'https://test-remix-2.vercel.app/32ratio.png',
      splashImageUrl: 'https://test-remix-2.vercel.app/32ratio.png',
      ...
      tags: ['finance'],
      heroImageUrl: 'https://test-remix-2.vercel.app/32ratio.png',
      tagline: 'Save instantly',
      ogTitle: 'Dopamint',
      ogDescription: 'Think Dopamint as CapCut meets Pump.fun. Prompt NFT',
      ogImageUrl: 'https://test-remix-2.vercel.app/32ratio.png',
